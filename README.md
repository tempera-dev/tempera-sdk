...
| `temperaGym` / `tempera_gym` | [tempera-gym](https://github.com/tempera-dev/tempera-gym) — shared RL task, verifier, episode, environment, and trajectory substrate | 15 | `tempera-gym` |
