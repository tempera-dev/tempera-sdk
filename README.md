...
| `temperaWorkflows` / `tempera_workflows` | [tempera-workflows](https://github.com/tempera-dev/tempera-workflows) — deterministic bounded-DAG workflow engine (definitions, validation, runs, and unsaved Bio campaign compilation; run SSE events via passthrough) | 17 | `tempera-workflows` |
