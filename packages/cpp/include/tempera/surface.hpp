...
inline constexpr std::string_view kStrings474[] = {"expectedRevision", "record"};
inline constexpr std::string_view kStrings475[] = {"record"};
inline constexpr std::string_view kStrings476[] = {"expectedRevision", "quoteId"};
inline constexpr std::string_view kStrings477[] = {"proposalId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings478[] = {"expectedRevision", "proposalDigest"};
inline constexpr std::string_view kStrings479[] = {"expectedRevision", "proposalDigest", "outcome", "evidenceRef"};
inline constexpr std::string_view kStrings480[] = {"expectedRevision", "purchaseState", "evidenceRef"};
inline constexpr std::string_view kStrings481[] = {"expectedRevision", "profileRef", "profileRevision", "idempotencyKey"};
inline constexpr std::string_view kStrings482[] = {"expectedRevision", "profileRef", "profileRevision"};
inline constexpr std::string_view kStrings483[] = {"workspaceId", "taskId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings484[] = {"expectedRevision", "draft"};
inline constexpr std::string_view kStrings485[] = {"expectedRevision", "review"};
inline constexpr std::string_view kStrings486[] = {"expectedRevision", "receipt"};
inline constexpr std::string_view kStrings487[] = {"workspaceId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings488[] = {"idempotencyKey", "intake", "profileRef"};
inline constexpr std::string_view kStrings489[] = {"idempotencyKey", "intake"};
inline constexpr std::string_view kStrings490[] = {"caseId"};
inline constexpr std::string_view kStrings491[] = {"idempotencyKey", "expectedRevision", "intake"};
inline constexpr std::string_view kStrings492[] = {"idempotencyKey", "expectedRevision", "draft"};
inline constexpr std::string_view kStrings493[] = {"idempotencyKey", "expectedRevision", "preparationDigest", "decision"};
inline constexpr std::string_view kStrings494[] = {"idempotencyKey", "expectedRevision", "preparationDigest", "receiptRef", "owner", "reportedOutcome"};
inline constexpr std::string_view kStrings495[] = {"idempotencyKey", "facts", "references", "availableServices"};
inline constexpr std::string_view kStrings496[] = {"idempotencyKey"};
inline constexpr std::string_view kStrings497[] = {"idempotencyKey", "expectedRevision", "facts", "references", "availableServices"};
inline constexpr std::string_view kStrings498[] = {"idempotencyKey", "expectedRevision"};
inline constexpr std::string_view kStrings499[] = {"idempotencyKey", "expectedRevision", "reason"};
inline constexpr std::string_view kStrings500[] = {"authScheme", "baseUrl", "connectorId", "connectorRevision", "credentialName", "displayName", "operations", "specificationArtifactRef", "specificationDigest"};
inline constexpr std::string_view kStrings501[] = {"connectorId", "displayName"};
inline constexpr std::string_view kStrings502[] = {"idempotencyKey", "input", "operationId"};
inline constexpr std::string_view kStrings503[] = {"operationId"};
inline constexpr std::string_view kStrings504[] = {"authScheme", "baseUrl", "connectorId", "credentialName", "displayName", "document", "sourceUrl"};
inline constexpr std::string_view kStrings505[] = {"displayName", "authScheme"};
inline constexpr std::string_view kStrings506[] = {"project", "profile"};
inline constexpr std::string_view kStrings507[] = {"project", "investigation"};
inline constexpr std::string_view kStrings508[] = {"project", "investigation", "evaluation"};
inline constexpr std::string_view kStrings509[] = {"project", "investigation", "run"};
inline constexpr std::string_view kStrings510[] = {"operation"};
inline constexpr std::string_view kStrings511[] = {"actionId", "actor", "authorityAdmission", "causality", "evidence", "expiresAt", "idempotencyKey", "mandate", "preparedEffect", "principal", "purpose", "requestDigest", "risk", "schema", "workspace"};
inline constexpr std::string_view kStrings512[] = {"schema", "actionId", "workspace", "principal", "actor", "purpose", "idempotencyKey", "causality", "preparedEffect", "mandate", "authorityAdmission", "risk", "evidence", "expiresAt", "requestDigest"};
inline constexpr std::string_view kStrings513[] = {"schema", "actionId", "workspace", "idempotencyKey", "preparedEffect"};
inline constexpr std::string_view kStrings514[] = {"action", "riskEvidenceEnvelope"};
...
inline constexpr std::array<OperationSpec, 614> OPERATIONS{{
    OperationSpec{
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings477,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings485,
        .forbidden_body = {},
        .required_body = detail::kStrings485,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "orders:approve",
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings487,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings490,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings492,
        .forbidden_body = {},
        .required_body = detail::kStrings492,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "business:write",
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings500,
        .forbidden_body = {},
        .required_body = detail::kStrings501,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-investigations",
        .path_params = detail::kStrings506,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-investigations",
        .path_params = detail::kStrings507,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings511,
        .forbidden_body = {},
        .required_body = detail::kStrings512,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings513,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "clearing:actions:propose",
