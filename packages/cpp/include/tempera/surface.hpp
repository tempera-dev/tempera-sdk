...
inline constexpr std::string_view kStrings280[] = {"tenantId", "merchantId", "riskSubjectId", "recipient", "asset", "amount", "expiresInSeconds"};
inline constexpr std::string_view kStrings281[] = {"paymentIntentId"};
inline constexpr std::string_view kStrings282[] = {"tenantId", "currency", "productName", "successUrl", "cancelUrl"};
inline constexpr std::string_view kStrings283[] = {"tenantId", "acquirer", "successUrl", "failureUrl", "billing"};
inline constexpr std::string_view kStrings284[] = {"tenantId", "country", "currency", "category"};
inline constexpr std::string_view kStrings285[] = {"merchantId"};
inline constexpr std::string_view kStrings286[] = {"Stripe-Signature"};
inline constexpr std::string_view kStrings287[] = {"projectId"};
inline constexpr std::string_view kStrings288[] = {"upload"};
inline constexpr std::string_view kStrings289[] = {"projectId", "documentId"};
inline constexpr std::string_view kStrings290[] = {"extraction", "metadata"};
inline constexpr std::string_view kStrings291[] = {"instructions", "maxOutputTokens", "schema", "schemaName", "unitIndexes"};
inline constexpr std::string_view kStrings292[] = {"schemaName", "schema", "instructions"};
inline constexpr std::string_view kStrings293[] = {"kind"};
inline constexpr std::string_view kStrings294[] = {"query", "strategy", "topK"};
inline constexpr std::string_view kStrings295[] = {"query"};
inline constexpr std::string_view kStrings296[] = {"profile"};
inline constexpr std::string_view kStrings297[] = {"projectId", "operationId"};
inline constexpr std::string_view kStrings298[] = {"expectedByteLength", "expectedSha256", "mediaType"};
inline constexpr std::string_view kStrings299[] = {"mediaType"};
inline constexpr std::string_view kStrings300[] = {"projectId", "uploadId"};
inline constexpr std::string_view kStrings301[] = {"byteLength", "sha256"};
inline constexpr std::string_view kStrings302[] = {"actor", "adapterId", "sensitiveActivityMode", "sensitivity", "ttlSeconds"};
inline constexpr std::string_view kStrings303[] = {"actor", "sensitivity"};
inline constexpr std::string_view kStrings304[] = {"adapterId", "contractVersion", "egressLogSealedOrDiscarded", "notes", "plaintextArtifactsRemoved", "processTerminated", "proofIds", "requestId", "sealedArtifactHandles", "temporaryProfileRemoved"};
inline constexpr std::string_view kStrings305[] = {"requestId", "adapterId", "contractVersion", "processTerminated", "temporaryProfileRemoved", "plaintextArtifactsRemoved", "egressLogSealedOrDiscarded", "sealedArtifactHandles", "proofIds", "notes"};
inline constexpr std::string_view kStrings306[] = {"launchRequest"};
inline constexpr std::string_view kStrings307[] = {"admission", "manifest", "sameUserCapability"};
inline constexpr std::string_view kStrings308[] = {"sameUserCapability", "admission", "manifest"};
inline constexpr std::string_view kStrings309[] = {"actor", "manifest", "sameUserCapability", "sensitivity"};
inline constexpr std::string_view kStrings310[] = {"actor", "sensitivity", "sameUserCapability", "manifest"};
inline constexpr std::string_view kStrings311[] = {"adapterId", "completionProofs", "contractVersion", "guardFields", "launchEndpoint", "supportedControls", "supportedLevels"};
inline constexpr std::string_view kStrings312[] = {"adapterId", "contractVersion", "launchEndpoint", "supportedLevels", "supportedControls", "guardFields", "completionProofs"};
inline constexpr std::string_view kStrings313[] = {"actor", "allowDowngrade", "artifactMode", "credentialMode", "requestedLevel", "requiredControls", "sensitiveActivityMode", "sensitivity", "targetOrigins", "taskLabel"};
inline constexpr std::string_view kStrings314[] = {"requestedLevel", "actor", "sensitivity"};
inline constexpr std::string_view kStrings315[] = {"entrypoint", "idempotencyKey", "input", "lane", "policy", "source", "stdin"};
inline constexpr std::string_view kStrings316[] = {"bytesBase64"};
inline constexpr std::string_view kStrings317[] = {"project", "sha256"};
inline constexpr std::string_view kStrings318[] = {"tenantId", "projectId", "environmentId", "kind", "text", "idempotencyKey", "project"};
inline constexpr std::string_view kStrings319[] = {"tenantId", "projectId", "kind", "text"};
inline constexpr std::string_view kStrings320[] = {"question", "scope", "maxTokens", "requireFresh", "modes", "reconstructionMode", "maxReconstructionSteps", "maxReconstructionTokens"};
inline constexpr std::string_view kStrings321[] = {"question", "scope"};
inline constexpr std::string_view kStrings322[] = {"vacuum", "repairOrphans", "pruneAuditBeforeUnixMs", "retainLatestAuditEvents"};
inline constexpr std::string_view kStrings323[] = {"parent"};
inline constexpr std::string_view kStrings324[] = {"parent", "useCaseId"};
inline constexpr std::string_view kStrings325[] = {"x-request-id"};
inline constexpr std::string_view kStrings326[] = {"artifactType", "source", "externalId", "rawBody", "metadata"};
inline constexpr std::string_view kStrings327[] = {"evidence", "artifactBase64"};
inline constexpr std::string_view kStrings328[] = {"url", "artifactType", "timeoutSeconds", "maxBytes", "producerVersion", "metadata"};
inline constexpr std::string_view kStrings329[] = {"x-request-id", "Idempotency-Key"};
inline constexpr std::string_view kStrings330[] = {"taskFamily", "targetAccuracy", "budgetCents", "rubric", "skillTags", "requiredReviews", "qualificationPolicy", "routingPolicy", "annotationSchema", "idempotencyKey"};
inline constexpr std::string_view kStrings331[] = {"parent", "campaignId"};
inline constexpr std::string_view kStrings332[] = {"targetStatus", "idempotencyKey"};
inline constexpr std::string_view kStrings333[] = {"useCase", "verifier", "budgetCents", "targetAccuracy", "rubric", "skillTags", "requiredReviews", "urls", "artifacts"};
inline constexpr std::string_view kStrings334[] = {"useCase"};
inline constexpr std::string_view kStrings335[] = {"pageSize", "pageToken", "status", "campaignName", "orderBy"};
inline constexpr std::string_view kStrings336[] = {"sourceExpertTaskName", "expectedLabel", "mode", "feedbackPolicy", "idempotencyKey"};
inline constexpr std::string_view kStrings337[] = {"sourceExpertTaskName", "expectedLabel", "idempotencyKey"};
inline constexpr std::string_view kStrings338[] = {"reviewerRef", "reason", "idempotencyKey"};
inline constexpr std::string_view kStrings339[] = {"parent", "expertTaskId"};
inline constexpr std::string_view kStrings340[] = {"label", "outcome", "confidence", "rationale", "evidence", "annotation", "annotatorId", "idempotencyKey", "leaseToken", "reviewContext"};
inline constexpr std::string_view kStrings341[] = {"label", "idempotencyKey", "reviewContext"};
inline constexpr std::string_view kStrings342[] = {"rationale", "evidence", "idempotencyKey"};
inline constexpr std::string_view kStrings343[] = {"rationale", "idempotencyKey"};
inline constexpr std::string_view kStrings344[] = {"idempotencyKey", "leaseToken", "leaseDurationSeconds"};
inline constexpr std::string_view kStrings345[] = {"idempotencyKey", "leaseToken"};
inline constexpr std::string_view kStrings346[] = {"idempotencyKey", "leaseToken", "draft", "expectedVersion"};
inline constexpr std::string_view kStrings347[] = {"event", "sessionId"};
inline constexpr std::string_view kStrings348[] = {"windowSeconds", "slaTargetSeconds"};
inline constexpr std::string_view kStrings349[] = {"pageSize", "pageToken", "view"};
inline constexpr std::string_view kStrings350[] = {"parent", "artifactId"};
inline constexpr std::string_view kStrings351[] = {"view"};
inline constexpr std::string_view kStrings352[] = {"artifactIds", "artifactType"};
inline constexpr std::string_view kStrings353[] = {"artifactIds", "taskFamily", "campaign", "targetAccuracy", "idempotencyKey", "verifier"};
inline constexpr std::string_view kStrings354[] = {"artifactIds", "taskFamily"};
inline constexpr std::string_view kStrings355[] = {"parent", "jobId"};
inline constexpr std::string_view kStrings356[] = {"parent", "productId"};
inline constexpr std::string_view kStrings357[] = {"productIds"};
inline constexpr std::string_view kStrings358[] = {"trainingProductId", "heldoutProductId", "idempotencyKey"};
inline constexpr std::string_view kStrings359[] = {"parent", "releaseId"};
inline constexpr std::string_view kStrings360[] = {"format", "trainFraction", "includeRaw", "pageSize", "pageToken", "pairSources"};
inline constexpr std::string_view kStrings361[] = {"format"};
inline constexpr std::string_view kStrings362[] = {"artifactIds", "job"};
inline constexpr std::string_view kStrings363[] = {"sourceDefinitionId"};
inline constexpr std::string_view kStrings364[] = {"connector", "connectionRef", "connectionRevision", "config", "artifactType", "source", "metadata", "enabled"};
inline constexpr std::string_view kStrings365[] = {"connector", "connectionRef", "connectionRevision", "config", "artifactType"};
inline constexpr std::string_view kStrings366[] = {"parent", "sourceDefinitionId"};
inline constexpr std::string_view kStrings367[] = {"etag", "connector", "connectionRef", "connectionRevision", "config", "artifactType", "source", "metadata", "enabled"};
inline constexpr std::string_view kStrings368[] = {"etag"};
inline constexpr std::string_view kStrings369[] = {"producerVersion", "idempotencyKey"};
inline constexpr std::string_view kStrings370[] = {"parent", "connectorRunId"};
inline constexpr std::string_view kStrings371[] = {"connector", "bucket", "prefix", "key", "maxObjects", "maxBytes", "statement", "limit", "soql", "maxPages", "artifactType", "source", "ingest", "metadata"};
inline constexpr std::string_view kStrings372[] = {"connector"};
inline constexpr std::string_view kStrings373[] = {"name", "description", "inputSchema", "kind", "implementation", "createdBy"};
inline constexpr std::string_view kStrings374[] = {"name", "description", "kind", "implementation"};
inline constexpr std::string_view kStrings375[] = {"parent", "toolName"};
inline constexpr std::string_view kStrings376[] = {"arguments"};
inline constexpr std::string_view kStrings377[] = {"schemaVersion", "requestId", "releaseId", "releaseKind", "evidenceClass", "claimClass", "bindings", "lineageEdges", "budget", "eligibility", "prospectiveExecution"};
inline constexpr std::string_view kStrings378[] = {"parent", "discoveryReleaseId"};
inline constexpr std::string_view kStrings379[] = {"schemaVersion", "domain", "evidenceType", "payloadSchema", "payload", "sourceArtifactRefs", "artifactRefs", "verificationState", "verifierReceiptArtifactRefs", "qualityFlags", "provenance"};
inline constexpr std::string_view kStrings380[] = {"schemaVersion", "domain", "evidenceType", "payloadSchema", "payload", "sourceArtifactRefs", "verificationState"};
inline constexpr std::string_view kStrings381[] = {"pageSize", "pageToken", "domain"};
inline constexpr std::string_view kStrings382[] = {"parent", "evidenceRecordId"};
inline constexpr std::string_view kStrings383[] = {"schemaVersion", "domain", "contextEvidenceRef", "environmentRef", "seed", "observations", "toolCalls", "measuredOutcomes", "verifierResults", "rewardComponents", "terminalReason", "uncertainty", "provenance", "safetyEvents"};
inline constexpr std::string_view kStrings384[] = {"schemaVersion", "domain", "contextEvidenceRef", "environmentRef", "seed", "observations", "measuredOutcomes", "verifierResults", "rewardComponents", "terminalReason"};
inline constexpr std::string_view kStrings385[] = {"parent", "episodeId"};
inline constexpr std::string_view kStrings386[] = {"contractVersion", "requestId", "obligation", "kinds", "epistemicStatuses", "checkerTrust", "includeEquivalent", "includeFailures", "under", "limit"};
inline constexpr std::string_view kStrings387[] = {"contractVersion", "requestId", "obligation", "limit"};
inline constexpr std::string_view kStrings388[] = {"kind", "version", "obligationHash", "capabilityRoute", "provenance", "tags", "contentHash"};
inline constexpr std::string_view kStrings389[] = {"kind", "version", "obligationHash", "capabilityRoute", "provenance"};
inline constexpr std::string_view kStrings390[] = {"parent", "entryId"};
inline constexpr std::string_view kStrings391[] = {"productId", "releaseId"};
inline constexpr std::string_view kStrings392[] = {"id", "name", "useCase", "instructions", "provider", "model", "voice", "language", "outputModality", "inputAudioFormat", "outputAudioFormat", "transcriptionModel", "turnDetection", "tools", "retention", "limits", "metadata"};
inline constexpr std::string_view kStrings393[] = {"name", "instructions"};
inline constexpr std::string_view kStrings394[] = {"agentId"};
inline constexpr std::string_view kStrings395[] = {"agentId", "channel", "externalId", "safetyIdentifier", "profileRef", "goalRef", "siteId", "metadata"};
inline constexpr std::string_view kStrings396[] = {"agentId", "profileRef", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings397[] = {"status", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings398[] = {"actionId"};
inline constexpr std::string_view kStrings399[] = {"approved", "note"};
inline constexpr std::string_view kStrings400[] = {"approved"};
inline constexpr std::string_view kStrings401[] = {"sessionIds"};
inline constexpr std::string_view kStrings402[] = {"name", "contentBase64", "mediaType", "classification"};
inline constexpr std::string_view kStrings403[] = {"name", "contentBase64"};
inline constexpr std::string_view kStrings404[] = {"reference"};
inline constexpr std::string_view kStrings405[] = {"profileId", "draft"};
inline constexpr std::string_view kStrings406[] = {"profileId", "sealedResultPath", "artifacts", "attestationPath", "attestationSignaturePath", "attestationPublicKeyPath"};
inline constexpr std::string_view kStrings407[] = {"profileId", "sealedResultPath", "artifacts"};
inline constexpr std::string_view kStrings408[] = {"profileId", "adapterImportPath", "adapterImportSignaturePath", "adapterImportPublicKeyPath", "releaseEvidencePath", "exposureLedgerPath", "redactionPolicyPath", "guardrailsPath", "preregistrationPath", "bundleId", "createdAt"};
inline constexpr std::string_view kStrings409[] = {"profileId", "adapterImportPath", "adapterImportSignaturePath", "adapterImportPublicKeyPath", "releaseEvidencePath", "exposureLedgerPath", "redactionPolicyPath", "guardrailsPath", "preregistrationPath", "bundleId"};
inline constexpr std::string_view kStrings410[] = {"profileId", "evidencePath", "kind", "signaturePath", "publicKeyPath", "tenantId", "projectId", "abPlanPath"};
inline constexpr std::string_view kStrings411[] = {"profileId", "evidencePath", "kind", "signaturePath", "publicKeyPath", "tenantId", "projectId"};
inline constexpr std::string_view kStrings412[] = {"handoffPath"};
inline constexpr std::string_view kStrings413[] = {"organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings414[] = {"id", "displayName", "channel"};
inline constexpr std::string_view kStrings415[] = {"id", "displayName"};
inline constexpr std::string_view kStrings416[] = {"pageToken", "pageSize"};
inline constexpr std::string_view kStrings417[] = {"storeId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings418[] = {"merchantId", "productClassification", "name", "description", "photoUrl", "currency", "unitAmountMinor", "expiresAt"};
inline constexpr std::string_view kStrings419[] = {"merchantId", "productClassification", "name", "description", "currency", "unitAmountMinor"};
inline constexpr std::string_view kStrings420[] = {"offerId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings421[] = {"offerId", "offerRevision", "quantity"};
inline constexpr std::string_view kStrings422[] = {"orderId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings423[] = {"expectedRevision", "record"};
inline constexpr std::string_view kStrings424[] = {"record"};
inline constexpr std::string_view kStrings425[] = {"expectedRevision", "quoteId"};
inline constexpr std::string_view kStrings426[] = {"proposalId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings427[] = {"expectedRevision", "proposalDigest"};
inline constexpr std::string_view kStrings428[] = {"expectedRevision", "proposalDigest", "outcome", "evidenceRef"};
inline constexpr std::string_view kStrings429[] = {"expectedRevision", "purchaseState", "evidenceRef"};
inline constexpr std::string_view kStrings430[] = {"expectedRevision", "profileRef", "profileRevision", "idempotencyKey"};
inline constexpr std::string_view kStrings431[] = {"expectedRevision", "profileRef", "profileRevision"};
inline constexpr std::string_view kStrings432[] = {"workspaceId", "taskId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings433[] = {"expectedRevision", "draft"};
inline constexpr std::string_view kStrings434[] = {"expectedRevision", "review"};
inline constexpr std::string_view kStrings435[] = {"expectedRevision", "receipt"};
inline constexpr std::string_view kStrings436[] = {"workspaceId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings437[] = {"idempotencyKey", "intake", "profileRef"};
inline constexpr std::string_view kStrings438[] = {"idempotencyKey", "intake"};
inline constexpr std::string_view kStrings439[] = {"caseId"};
inline constexpr std::string_view kStrings440[] = {"idempotencyKey", "expectedRevision", "intake"};
inline constexpr std::string_view kStrings441[] = {"idempotencyKey", "expectedRevision", "draft"};
inline constexpr std::string_view kStrings442[] = {"idempotencyKey", "expectedRevision", "preparationDigest", "decision"};
inline constexpr std::string_view kStrings443[] = {"idempotencyKey", "expectedRevision", "preparationDigest", "receiptRef", "owner", "reportedOutcome"};
inline constexpr std::string_view kStrings444[] = {"idempotencyKey", "facts", "references", "availableServices"};
inline constexpr std::string_view kStrings445[] = {"idempotencyKey"};
inline constexpr std::string_view kStrings446[] = {"idempotencyKey", "expectedRevision", "facts", "references", "availableServices"};
inline constexpr std::string_view kStrings447[] = {"idempotencyKey", "expectedRevision"};
inline constexpr std::string_view kStrings448[] = {"idempotencyKey", "expectedRevision", "reason"};
inline constexpr std::string_view kStrings449[] = {"authScheme", "baseUrl", "connectorId", "connectorRevision", "credentialName", "displayName", "operations", "specificationArtifactRef", "specificationDigest"};
inline constexpr std::string_view kStrings450[] = {"connectorId", "displayName"};
inline constexpr std::string_view kStrings451[] = {"idempotencyKey", "input", "operationId"};
inline constexpr std::string_view kStrings452[] = {"operationId"};
inline constexpr std::string_view kStrings453[] = {"authScheme", "baseUrl", "connectorId", "credentialName", "displayName", "document", "sourceUrl"};
inline constexpr std::string_view kStrings454[] = {"displayName", "authScheme"};
inline constexpr std::string_view kStrings455[] = {"project", "profile"};
inline constexpr std::string_view kStrings456[] = {"project", "investigation"};
inline constexpr std::string_view kStrings457[] = {"project", "investigation", "evaluation"};
inline constexpr std::string_view kStrings458[] = {"project", "investigation", "run"};
inline constexpr std::string_view kStrings459[] = {"operation"};
inline constexpr std::string_view kStrings460[] = {"actionId", "actor", "authorityAdmission", "causality", "evidence", "expiresAt", "idempotencyKey", "mandate", "preparedEffect", "principal", "purpose", "requestDigest", "risk", "schema", "workspace"};
inline constexpr std::string_view kStrings461[] = {"schema", "actionId", "workspace", "principal", "actor", "purpose", "idempotencyKey", "causality", "preparedEffect", "mandate", "authorityAdmission", "risk", "evidence", "expiresAt", "requestDigest"};
inline constexpr std::string_view kStrings462[] = {"schema", "actionId", "workspace", "idempotencyKey", "preparedEffect"};
inline constexpr std::string_view kStrings463[] = {"action", "riskEvidenceEnvelope"};
...
inline constexpr std::array<OperationSpec, 553> OPERATIONS{{
    OperationSpec{
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-payments",
        .path_params = detail::kStrings285,
        .path_param_templates = {},
        .query = detail::kStrings150,
        .required_query = detail::kStrings150,
        .headers = {},
    ...
    OperationSpec{
        ...
        .query = {},
        .required_query = {},
        .headers = detail::kStrings286,
        .required_headers = detail::kStrings286,
        .body = {},
        .forbidden_body = {},
        .required_body = {},
        .body_defaults = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings288,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-document",
        .path_params = detail::kStrings289,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings295,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "document:read",
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings312,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "cradle:execute",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "data-engine",
        .path_params = detail::kStrings355,
        .path_param_templates = detail::kPairs0,
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "data-engine",
        .path_params = detail::kStrings356,
        .path_param_templates = detail::kPairs0,
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings362,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "eval:run",
    ...
    OperationSpec{
        ...
        .path_params = detail::kStrings323,
        .path_param_templates = detail::kPairs0,
        .query = detail::kStrings363,
        .required_query = detail::kStrings363,
        .headers = {},
        .required_headers = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings369,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "connector:run",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "data-engine",
        .path_params = detail::kStrings370,
        .path_param_templates = detail::kPairs0,
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings377,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "eval:run",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "data-engine",
        .path_params = detail::kStrings378,
        .path_param_templates = detail::kPairs0,
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "data-engine",
        .path_params = detail::kStrings385,
        .path_param_templates = detail::kPairs0,
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .path_params = {},
        .path_param_templates = {},
        .query = detail::kStrings391,
        .required_query = detail::kStrings391,
        .headers = {},
        .required_headers = {},
        .body = {},
        .forbidden_body = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-voice",
        .path_params = detail::kStrings394,
        .path_param_templates = {},
        .query = detail::kStrings7,
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-voice",
        .path_params = detail::kStrings398,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings400,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "voice:write",
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings402,
        .forbidden_body = {},
        .required_body = detail::kStrings403,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "voice:write",
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings420,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings432,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings439,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .path_params = detail::kStrings455,
        .path_param_templates = {},
        .query = detail::kStrings368,
        .required_query = detail::kStrings368,
        .headers = {},
        .required_headers = {},
        .body = {},
        .forbidden_body = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-investigations",
        .path_params = detail::kStrings456,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-investigations",
        .path_params = detail::kStrings458,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
