...
inline constexpr std::array<ProductSpec, 21> PRODUCTS{{
    ProductSpec{
        .key = "control_plane",
        .name = "auth-hub",
...
inline constexpr std::string_view kStrings165[] = {"request", "peopleBinding"};
inline constexpr std::string_view kStrings166[] = {"request"};
inline constexpr std::string_view kStrings167[] = {"schema", "subjectId", "subjectType", "state", "attributes", "externalRefs"};
inline constexpr std::string_view kStrings168[] = {"schema", "subjectId", "subjectType"};
inline constexpr std::string_view kStrings169[] = {"project", "subjectId"};
inline constexpr std::string_view kStrings170[] = {"schema", "eventId", "eventType", "subjectId", "counterpartyId", "deviceId", "amount", "eventTime", "receivedAt", "attributes", "evidenceRefs"};
inline constexpr std::string_view kStrings171[] = {"schema", "eventId", "eventType", "subjectId", "eventTime", "receivedAt"};
inline constexpr std::string_view kStrings172[] = {"schema", "policyId", "version", "useCase", "segment", "description", "defaultAction", "defaultReasonCode", "missingDataAction", "missingDataReasonCode", "conflictStrategy", "rules", "modelDependencies", "changeTicket", "createdBy"};
inline constexpr std::string_view kStrings173[] = {"schema", "policyId", "version", "useCase", "defaultAction", "defaultReasonCode", "missingDataAction", "missingDataReasonCode", "conflictStrategy", "rules", "changeTicket", "createdBy"};
inline constexpr std::string_view kStrings174[] = {"schema", "modelId", "version", "state", "artifactSha256", "runtime", "inputFeatures", "outputFeature", "trainingDataRefs", "validationReportRef", "calibration", "limitations", "createdAt", "approvalIds"};
inline constexpr std::string_view kStrings175[] = {"schema", "algorithm", "keyId", "score", "signature"};
inline constexpr std::string_view kStrings176[] = {"action", "target"};
inline constexpr std::string_view kStrings177[] = {"deploymentId", "policyId", "policyVersion", "mode", "trafficPercent", "effectiveAt", "approvalIds"};
inline constexpr std::string_view kStrings178[] = {"schema", "requestId", "subjectId", "eventId", "useCase", "segment", "features", "modelVersions", "evidenceRefs", "asOf", "availableAsOf", "executionMode"};
inline constexpr std::string_view kStrings179[] = {"schema", "requestId", "subjectId", "useCase", "asOf"};
inline constexpr std::string_view kStrings180[] = {"project", "decisionId"};
inline constexpr std::string_view kStrings181[] = {"indexName", "subject", "permissiblePurpose", "caseId", "threshold", "maxCandidates"};
inline constexpr std::string_view kStrings182[] = {"indexName", "subject", "permissiblePurpose", "caseId"};
inline constexpr std::string_view kStrings183[] = {"schema", "caseId", "caseType", "state", "subjectIds", "alertIds", "assignedTo", "disposition", "evidenceRefs", "attributes"};
inline constexpr std::string_view kStrings184[] = {"project", "caseId"};
inline constexpr std::string_view kStrings185[] = {"schema", "grantId", "caseId", "subjectIds", "actorIds", "permissiblePurpose", "allowedFields", "allowedProviders", "thirdPartyDisclosureAllowed", "validFrom", "expiresAt", "createdBy", "approvalIds", "changeTicket"};
inline constexpr std::string_view kStrings186[] = {"project", "grantId"};
inline constexpr std::string_view kStrings187[] = {"reason"};
inline constexpr std::string_view kStrings188[] = {"schema", "profileId", "subjectId", "entityKind", "anchors", "attributes", "sourceIds", "evidenceRefs", "validFrom", "validTo", "recordedAt", "retentionExpiresAt", "nonDecisional"};
inline constexpr std::string_view kStrings189[] = {"schema", "profileId", "subjectId", "entityKind", "anchors", "attributes", "sourceIds", "evidenceRefs", "validFrom", "validTo", "recordedAt", "retentionExpiresAt"};
inline constexpr std::string_view kStrings190[] = {"schema", "queryId", "subjectId", "accessGrantId", "caseId", "permissiblePurpose", "entityKind", "anchors", "attributes", "maxCandidates", "asOf", "knownAt"};
inline constexpr std::string_view kStrings191[] = {"project", "sourcePackId"};
inline constexpr std::string_view kStrings192[] = {"subject", "question", "purpose", "permissiblePurpose", "outputSchema", "budgets", "sourcePolicy", "caseId", "accessGrantId", "actorId", "retentionPolicyId", "humanReviewRequired", "candidateBinding", "providerPlan", "investigationProfile", "sourcePackIds", "continuationOfJobId"};
inline constexpr std::string_view kStrings193[] = {"subject", "question", "purpose", "permissiblePurpose", "outputSchema", "budgets", "sourcePolicy", "caseId", "actorId", "retentionPolicyId", "humanReviewRequired"};
...
inline constexpr std::string_view kStrings196[] = {"afterSequence", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings197[] = {"approved", "reason"};
inline constexpr std::string_view kStrings198[] = {"envelope"};
inline constexpr std::string_view kStrings199[] = {"project", "reservationId"};
inline constexpr std::string_view kStrings200[] = {"envelope", "abortReceiptDigest"};
inline constexpr std::string_view kStrings201[] = {"envelope", "dispatchAttemptDigest"};
inline constexpr std::string_view kStrings202[] = {"envelope", "executionReceiptDigest"};
inline constexpr std::string_view kStrings203[] = {"envelope", "outcomeDigest"};
inline constexpr std::string_view kStrings204[] = {"envelope", "compensationReceiptDigest"};
inline constexpr std::string_view kStrings205[] = {"envelope", "disputeEvidenceDigest"};
inline constexpr std::string_view kStrings206[] = {"envelope", "outcomeDigest", "realizedLoss"};
inline constexpr std::string_view kStrings207[] = {"approvalId", "connectionId", "experimentProposal", "mcpCommitReceiptDigest", "mcpPrepareReceiptDigest", "prospectiveProtocol", "submissionIdempotencyKey"};
inline constexpr std::string_view kStrings208[] = {"prospectiveProtocol", "experimentProposal", "connectionId", "approvalId", "mcpPrepareReceiptDigest", "mcpCommitReceiptDigest", "submissionIdempotencyKey"};
inline constexpr std::string_view kStrings209[] = {"submissionId"};
inline constexpr std::string_view kStrings210[] = {"workflowId", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings211[] = {"idempotencyKey", "payload", "payloadDigest", "signalName"};
inline constexpr std::string_view kStrings212[] = {"signalName", "idempotencyKey", "payload", "payloadDigest"};
inline constexpr std::string_view kStrings213[] = {"contractVersion", "description", "edges", "id", "name", "nodes", "settings"};
inline constexpr std::string_view kStrings214[] = {"contractVersion", "id", "name", "nodes", "edges"};
inline constexpr std::string_view kStrings215[] = {"workflowId"};
inline constexpr std::string_view kStrings216[] = {"idempotencyKey", "input", "only", "seedOutputs", "startAt", "usePinned"};
inline constexpr std::string_view kStrings217[] = {"idempotencyKey", "input", "only", "seedOutputs", "startAt", "usePinned", "waitMs"};
inline constexpr std::string_view kStrings218[] = {"deadlineMs", "maxRounds", "name", "signalExpiresAfterSeconds", "signalPrefix"};
inline constexpr std::string_view kStrings219[] = {"attachments", "draft", "history", "model", "prompt"};
inline constexpr std::string_view kStrings220[] = {"prompt"};
inline constexpr std::string_view kStrings221[] = {"context", "current", "expectedRoot", "mode", "prompt", "purpose"};
inline constexpr std::string_view kStrings222[] = {"mode", "purpose", "expectedRoot"};
inline constexpr std::string_view kStrings223[] = {"domain", "family", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings224[] = {"task"};
inline constexpr std::string_view kStrings225[] = {"version"};
inline constexpr std::string_view kStrings226[] = {"candidate", "seed", "receipts"};
inline constexpr std::string_view kStrings227[] = {"candidate"};
inline constexpr std::string_view kStrings228[] = {"domain", "status", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings229[] = {"task", "seed"};
inline constexpr std::string_view kStrings230[] = {"episode"};
inline constexpr std::string_view kStrings231[] = {"action", "receipts"};
inline constexpr std::string_view kStrings232[] = {"action"};
inline constexpr std::string_view kStrings233[] = {"contextEvidenceRef", "verifierReceiptArtifactRef", "requestId"};
inline constexpr std::string_view kStrings234[] = {"contextEvidenceRef"};
inline constexpr std::string_view kStrings235[] = {"environmentId", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings236[] = {"run"};
inline constexpr std::string_view kStrings237[] = {"environmentId", "policy", "seed", "maxSteps", "model", "dataEngineProductId", "dataEngineMaxRecords"};
inline constexpr std::string_view kStrings238[] = {"environmentId", "seed"};
inline constexpr std::string_view kStrings239[] = {"schemaVersion", "campaignDigest", "datasetDigest", "candidateSetDigest", "model", "policy", "shadowPolicies", "mode", "constraints", "candidates"};
inline constexpr std::string_view kStrings240[] = {"evaluator", "qualificationPolicy", "suite", "trainer"};
inline constexpr std::string_view kStrings241[] = {"evaluation"};
inline constexpr std::string_view kStrings242[] = {"policySubmission", "trainingReport"};
inline constexpr std::string_view kStrings243[] = {"candidateSet", "hypothesis", "program", "rounds"};
inline constexpr std::string_view kStrings244[] = {"program", "hypothesis", "candidateSet", "rounds"};
inline constexpr std::string_view kStrings245[] = {"candidates"};
inline constexpr std::string_view kStrings246[] = {"decision", "program", "verifierReceipts"};
inline constexpr std::string_view kStrings247[] = {"program", "decision", "verifierReceipts"};
inline constexpr std::string_view kStrings248[] = {"candidateSet", "experimentProposal", "hypothesis", "program", "verifierReceipts"};
inline constexpr std::string_view kStrings249[] = {"program", "hypothesis", "candidateSet", "experimentProposal", "verifierReceipts"};
inline constexpr std::string_view kStrings250[] = {"candidateSet", "program", "selectedCandidates"};
inline constexpr std::string_view kStrings251[] = {"program", "candidateSet", "selectedCandidates"};
inline constexpr std::string_view kStrings252[] = {"batchProposal", "campaignContext", "candidateSet", "program"};
inline constexpr std::string_view kStrings253[] = {"program", "candidateSet", "campaignContext", "batchProposal"};
inline constexpr std::string_view kStrings254[] = {"hypothesis"};
inline constexpr std::string_view kStrings255[] = {"candidate", "experimentProposal", "hypothesis", "identitySignature", "program", "rawMeasurementBase64"};
inline constexpr std::string_view kStrings256[] = {"candidate", "program", "hypothesis", "experimentProposal", "rawMeasurementBase64", "identitySignature"};
inline constexpr std::string_view kStrings257[] = {"candidateSet", "configuration", "hypothesis"};
inline constexpr std::string_view kStrings258[] = {"configuration", "hypothesis", "candidateSet"};
inline constexpr std::string_view kStrings259[] = {"configuration", "experimentProposal", "program"};
inline constexpr std::string_view kStrings260[] = {"configuration", "program", "experimentProposal"};
inline constexpr std::string_view kStrings261[] = {"candidate", "experimentProposal", "hypothesis", "measurementIdentitySignature", "program", "prospectiveProtocol", "providerResultEnvelope", "providerResultIdentitySignature", "rawChainOfCustodyBase64", "rawMeasurementBase64", "rawSubmissionReceiptBase64", "submissionIdentitySignature"};
inline constexpr std::string_view kStrings262[] = {"candidate", "program", "hypothesis", "experimentProposal", "prospectiveProtocol", "rawSubmissionReceiptBase64", "submissionIdentitySignature", "providerResultEnvelope", "providerResultIdentitySignature", "rawChainOfCustodyBase64", "rawMeasurementBase64", "measurementIdentitySignature"};
inline constexpr std::string_view kStrings263[] = {"scoreSetUrn"};
inline constexpr std::string_view kStrings264[] = {"tenantId", "merchantId", "riskSubjectId", "recipient", "asset", "amount", "expiresInSeconds"};
inline constexpr std::string_view kStrings265[] = {"paymentIntentId"};
inline constexpr std::string_view kStrings266[] = {"tenantId", "currency", "productName", "successUrl", "cancelUrl"};
inline constexpr std::string_view kStrings267[] = {"tenantId", "acquirer", "successUrl", "failureUrl", "billing"};
inline constexpr std::string_view kStrings268[] = {"tenantId", "country", "currency", "category"};
inline constexpr std::string_view kStrings269[] = {"merchantId"};
inline constexpr std::string_view kStrings270[] = {"Stripe-Signature"};
inline constexpr std::string_view kStrings271[] = {"projectId"};
inline constexpr std::string_view kStrings272[] = {"upload"};
inline constexpr std::string_view kStrings273[] = {"projectId", "documentId"};
inline constexpr std::string_view kStrings274[] = {"extraction", "metadata"};
inline constexpr std::string_view kStrings275[] = {"instructions", "maxOutputTokens", "schema", "schemaName", "unitIndexes"};
inline constexpr std::string_view kStrings276[] = {"schemaName", "schema", "instructions"};
inline constexpr std::string_view kStrings277[] = {"kind"};
inline constexpr std::string_view kStrings278[] = {"query", "strategy", "topK"};
inline constexpr std::string_view kStrings279[] = {"query"};
inline constexpr std::string_view kStrings280[] = {"profile"};
inline constexpr std::string_view kStrings281[] = {"projectId", "operationId"};
inline constexpr std::string_view kStrings282[] = {"expectedByteLength", "expectedSha256", "mediaType"};
inline constexpr std::string_view kStrings283[] = {"mediaType"};
inline constexpr std::string_view kStrings284[] = {"projectId", "uploadId"};
inline constexpr std::string_view kStrings285[] = {"byteLength", "sha256"};
...
inline constexpr std::string_view kStrings376[] = {"id", "name", "useCase", "instructions", "provider", "model", "voice", "language", "outputModality", "inputAudioFormat", "outputAudioFormat", "transcriptionModel", "turnDetection", "tools", "retention", "limits", "metadata"};
inline constexpr std::string_view kStrings377[] = {"name", "instructions"};
inline constexpr std::string_view kStrings378[] = {"agentId"};
inline constexpr std::string_view kStrings379[] = {"agentId", "channel", "externalId", "safetyIdentifier", "profileRef", "goalRef", "siteId", "metadata"};
inline constexpr std::string_view kStrings380[] = {"agentId", "profileRef", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings381[] = {"status", "pageSize", "pageToken"};
inline constexpr std::string_view kStrings382[] = {"actionId"};
inline constexpr std::string_view kStrings383[] = {"approved", "note"};
inline constexpr std::string_view kStrings384[] = {"approved"};
inline constexpr std::string_view kStrings385[] = {"sessionIds"};
inline constexpr std::string_view kStrings386[] = {"name", "contentBase64", "mediaType", "classification"};
inline constexpr std::string_view kStrings387[] = {"name", "contentBase64"};
inline constexpr std::string_view kStrings388[] = {"reference"};
inline constexpr std::string_view kStrings389[] = {"profileId", "draft"};
inline constexpr std::string_view kStrings390[] = {"profileId", "sealedResultPath", "artifacts", "attestationPath", "attestationSignaturePath", "attestationPublicKeyPath"};
inline constexpr std::string_view kStrings391[] = {"profileId", "sealedResultPath", "artifacts"};
inline constexpr std::string_view kStrings392[] = {"profileId", "adapterImportPath", "adapterImportSignaturePath", "adapterImportPublicKeyPath", "releaseEvidencePath", "exposureLedgerPath", "redactionPolicyPath", "guardrailsPath", "preregistrationPath", "bundleId", "createdAt"};
inline constexpr std::string_view kStrings393[] = {"profileId", "adapterImportPath", "adapterImportSignaturePath", "adapterImportPublicKeyPath", "releaseEvidencePath", "exposureLedgerPath", "redactionPolicyPath", "guardrailsPath", "preregistrationPath", "bundleId"};
inline constexpr std::string_view kStrings394[] = {"profileId", "evidencePath", "kind", "signaturePath", "publicKeyPath", "tenantId", "projectId", "abPlanPath"};
inline constexpr std::string_view kStrings395[] = {"profileId", "evidencePath", "kind", "signaturePath", "publicKeyPath", "tenantId", "projectId"};
inline constexpr std::string_view kStrings396[] = {"handoffPath"};
inline constexpr std::string_view kStrings397[] = {"organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings398[] = {"id", "displayName", "channel"};
inline constexpr std::string_view kStrings399[] = {"id", "displayName"};
inline constexpr std::string_view kStrings400[] = {"pageToken", "pageSize"};
inline constexpr std::string_view kStrings401[] = {"storeId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings402[] = {"merchantId", "productClassification", "name", "description", "photoUrl", "currency", "unitAmountMinor", "expiresAt"};
inline constexpr std::string_view kStrings403[] = {"merchantId", "productClassification", "name", "description", "currency", "unitAmountMinor"};
inline constexpr std::string_view kStrings404[] = {"offerId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings405[] = {"offerId", "offerRevision", "quantity"};
inline constexpr std::string_view kStrings406[] = {"orderId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings407[] = {"expectedRevision", "record"};
inline constexpr std::string_view kStrings408[] = {"record"};
inline constexpr std::string_view kStrings409[] = {"expectedRevision", "quoteId"};
inline constexpr std::string_view kStrings410[] = {"proposalId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings411[] = {"expectedRevision", "proposalDigest"};
inline constexpr std::string_view kStrings412[] = {"expectedRevision", "proposalDigest", "outcome", "evidenceRef"};
inline constexpr std::string_view kStrings413[] = {"expectedRevision", "purchaseState", "evidenceRef"};
inline constexpr std::string_view kStrings414[] = {"expectedRevision", "profileRef", "profileRevision", "idempotencyKey"};
inline constexpr std::string_view kStrings415[] = {"expectedRevision", "profileRef", "profileRevision"};
inline constexpr std::string_view kStrings416[] = {"workspaceId", "taskId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings417[] = {"expectedRevision", "draft"};
inline constexpr std::string_view kStrings418[] = {"expectedRevision", "review"};
inline constexpr std::string_view kStrings419[] = {"expectedRevision", "receipt"};
inline constexpr std::string_view kStrings420[] = {"workspaceId", "organization", "project", "environment", "site"};
inline constexpr std::string_view kStrings421[] = {"idempotencyKey", "intake", "profileRef"};
inline constexpr std::string_view kStrings422[] = {"idempotencyKey", "intake"};
inline constexpr std::string_view kStrings423[] = {"caseId"};
inline constexpr std::string_view kStrings424[] = {"idempotencyKey", "expectedRevision", "intake"};
inline constexpr std::string_view kStrings425[] = {"idempotencyKey", "expectedRevision", "draft"};
inline constexpr std::string_view kStrings426[] = {"idempotencyKey", "expectedRevision", "preparationDigest", "decision"};
inline constexpr std::string_view kStrings427[] = {"idempotencyKey", "expectedRevision", "preparationDigest", "receiptRef", "owner", "reportedOutcome"};
inline constexpr std::string_view kStrings428[] = {"idempotencyKey", "facts", "references", "availableServices"};
inline constexpr std::string_view kStrings429[] = {"idempotencyKey"};
inline constexpr std::string_view kStrings430[] = {"idempotencyKey", "expectedRevision", "facts", "references", "availableServices"};
inline constexpr std::string_view kStrings431[] = {"idempotencyKey", "expectedRevision"};
inline constexpr std::string_view kStrings432[] = {"idempotencyKey", "expectedRevision", "reason"};
inline constexpr std::string_view kStrings433[] = {"authScheme", "baseUrl", "connectorId", "connectorRevision", "credentialName", "displayName", "operations", "specificationArtifactRef", "specificationDigest"};
inline constexpr std::string_view kStrings434[] = {"connectorId", "displayName"};
inline constexpr std::string_view kStrings435[] = {"idempotencyKey", "input", "operationId"};
inline constexpr std::string_view kStrings436[] = {"operationId"};
inline constexpr std::string_view kStrings437[] = {"authScheme", "baseUrl", "connectorId", "credentialName", "displayName", "document", "sourceUrl"};
inline constexpr std::string_view kStrings438[] = {"displayName", "authScheme"};
...
inline constexpr std::array<OperationSpec, 504> OPERATIONS{{
    OperationSpec{
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-risk",
        .path_params = detail::kStrings199,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = detail::kStrings164,
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings207,
        .forbidden_body = {},
        .required_body = detail::kStrings208,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "bio:experiment:submit",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-workflows",
        .path_params = detail::kStrings209,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-gym",
        .path_params = detail::kStrings224,
        .path_param_templates = {},
        .query = detail::kStrings225,
        .required_query = {},
        .headers = {},
        .required_headers = {},
        .body = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings227,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "eval:run",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-gym",
        .path_params = detail::kStrings230,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings231,
        .forbidden_body = {},
        .required_body = detail::kStrings232,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "eval:run",
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings234,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "eval:run",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-gym",
        .path_params = detail::kStrings236,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-gym",
        .path_params = detail::kStrings241,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings247,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "bio:proposal:write",
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings248,
        .forbidden_body = {},
        .required_body = detail::kStrings249,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "bio:decision:write",
    ...
    OperationSpec{
        ...
        .headers = {},
        .required_headers = {},
        .body = detail::kStrings250,
        .forbidden_body = {},
        .required_body = detail::kStrings251,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "bio:proposal:write",
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings264,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
    ...
    OperationSpec{
        ...
        .auth = "oauthResource",
        .auth_audience = "tempera-payments",
        .path_params = detail::kStrings265,
        .path_param_templates = {},
        .query = detail::kStrings134,
        .required_query = detail::kStrings134,
        .headers = {},
        .required_headers = {},
        .body = {},
        .forbidden_body = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings417,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
        .scope = "orders:write",
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings422,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
    ...
    OperationSpec{
        ...
        .auth = "product",
        .auth_audience = std::nullopt,
        .path_params = detail::kStrings423,
        .path_param_templates = {},
        .query = {},
        .required_query = {},
        .headers = {},
    ...
    OperationSpec{
        ...
        .forbidden_body = {},
        .required_body = detail::kStrings426,
        .body_defaults = {},
        .request_body_kind = "json",
        .request_content_type = "application/json",
