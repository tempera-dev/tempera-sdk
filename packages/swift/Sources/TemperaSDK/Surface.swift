...
extension TemperaClient {
    ...
    public nonisolated var temperaConnectors: TemperaProductClient { productClient("temperaConnectors") }

    /// Long-running investigations with profiles, agentic and deterministic runs, findings, reviews and a replayable dossier.
    public nonisolated var temperaInvestigations: TemperaProductClient { productClient("temperaInvestigations") }
    ...
    public nonisolated var temperaClearing: TemperaProductClient { productClient("temperaClearing") }
}
...
private let temperaOperationChunk2: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["orgId", "projectId", "environmentId", "name", "document"],
        forbiddenBody: [],
        requiredBody: ["orgId", "projectId", "environmentId", "name", "document"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        pathParams: [],
        pathParamTemplates: [],
        query: ["pageSize", "pageToken", "state"],
        requiredQuery: [],
        headers: [],
        requiredHeaders: [],
        body: [],
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["orgId", "projectId", "environmentId", "serverName", "toolName", "callDigest", "surfaceDigest", "effect", "summary", "reaches", "evidence", "requiredApprovers", "holdTtlSeconds", "correlationId", "principalId", "policyId", "policyDigest", "approvalUrl"],
        forbiddenBody: [],
        requiredBody: ["orgId", "projectId", "environmentId", "serverName", "toolName", "callDigest", "effect"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
...
private let temperaOperationChunk3: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["decision", "note", "tokenTtlSeconds"],
        forbiddenBody: [],
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["decisionToken", "preparedEffectDigest", "callDigest", "leaseSeconds"],
        forbiddenBody: [],
        requiredBody: ["decisionToken", "preparedEffectDigest", "callDigest"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "authority:holds:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["leaseToken", "leaseFence", "outcomeDigest", "outcomeStatus", "outcomeRef"],
        forbiddenBody: [],
        requiredBody: ["leaseToken", "leaseFence", "outcomeDigest"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "authority:holds:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["orgId", "projectId", "environmentId", "name", "credentialId", "destination", "delivery", "mint", "releasePolicy"],
        forbiddenBody: [],
        requiredBody: ["name", "credentialId", "destination", "delivery", "releasePolicy"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "authority:policies:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["effectDigest", "callDigest", "holdId", "leaseToken", "effect", "serverName", "toolName", "ttlSeconds", "gateId", "principalId"],
        forbiddenBody: [],
        requiredBody: ["effectDigest", "callDigest"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        pathParams: [],
        pathParamTemplates: [],
        query: ["pageSize", "pageToken", "format"],
        requiredQuery: [],
        headers: [],
        requiredHeaders: [],
        body: [],
...
private let temperaOperationChunk6: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["schema", "subjectId", "subjectType", "state", "attributes", "externalRefs"],
        forbiddenBody: [],
        requiredBody: ["schema", "subjectId", "subjectType"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["schema", "eventId", "eventType", "subjectId", "counterpartyId", "deviceId", "amount", "eventTime", "receivedAt", "attributes", "evidenceRefs"],
        forbiddenBody: [],
        requiredBody: ["schema", "eventId", "eventType", "subjectId", "eventTime", "receivedAt"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["schema", "policyId", "version", "useCase", "segment", "description", "defaultAction", "defaultReasonCode", "missingDataAction", "missingDataReasonCode", "conflictStrategy", "rules", "modelDependencies", "changeTicket", "createdBy"],
        forbiddenBody: [],
        requiredBody: ["schema", "policyId", "version", "useCase", "defaultAction", "defaultReasonCode", "missingDataAction", "missingDataReasonCode", "conflictStrategy", "rules", "changeTicket", "createdBy"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["schema", "modelId", "version", "state", "artifactSha256", "runtime", "inputFeatures", "outputFeature", "trainingDataRefs", "validationReportRef", "calibration", "limitations", "createdAt", "approvalIds"],
        forbiddenBody: [],
        requiredBody: ["schema", "modelId", "version", "state", "artifactSha256", "runtime", "inputFeatures", "outputFeature", "trainingDataRefs", "validationReportRef", "calibration", "limitations", "createdAt", "approvalIds"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["schema", "algorithm", "keyId", "score", "signature"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["deploymentId", "policyId", "policyVersion", "mode", "trafficPercent", "effectiveAt", "approvalIds"],
        forbiddenBody: [],
        requiredBody: ["deploymentId", "policyId", "policyVersion", "mode", "trafficPercent", "effectiveAt", "approvalIds"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["schema", "requestId", "subjectId", "eventId", "useCase", "segment", "features", "modelVersions", "evidenceRefs", "asOf", "availableAsOf", "executionMode"],
        forbiddenBody: [],
        requiredBody: ["schema", "requestId", "subjectId", "useCase", "asOf"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["indexName", "subject", "permissiblePurpose", "caseId", "threshold", "maxCandidates"],
        forbiddenBody: [],
        requiredBody: ["indexName", "subject", "permissiblePurpose", "caseId"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["schema", "caseId", "caseType", "state", "subjectIds", "alertIds", "assignedTo", "disposition", "evidenceRefs", "attributes"],
        forbiddenBody: [],
        requiredBody: ["schema", "caseId", "caseType", "state", "subjectIds", "alertIds", "assignedTo", "disposition", "evidenceRefs", "attributes"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["schema", "grantId", "caseId", "subjectIds", "actorIds", "permissiblePurpose", "allowedFields", "allowedProviders", "thirdPartyDisclosureAllowed", "validFrom", "expiresAt", "createdBy", "approvalIds", "changeTicket"],
        forbiddenBody: [],
        requiredBody: ["schema", "grantId", "caseId", "subjectIds", "actorIds", "permissiblePurpose", "allowedFields", "allowedProviders", "thirdPartyDisclosureAllowed", "validFrom", "expiresAt", "createdBy", "approvalIds", "changeTicket"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["schema", "profileId", "subjectId", "entityKind", "anchors", "attributes", "sourceIds", "evidenceRefs", "validFrom", "validTo", "recordedAt", "retentionExpiresAt", "nonDecisional"],
        forbiddenBody: [],
        requiredBody: ["schema", "profileId", "subjectId", "entityKind", "anchors", "attributes", "sourceIds", "evidenceRefs", "validFrom", "validTo", "recordedAt", "retentionExpiresAt"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["schema", "queryId", "subjectId", "accessGrantId", "caseId", "permissiblePurpose", "entityKind", "anchors", "attributes", "maxCandidates", "asOf", "knownAt"],
        forbiddenBody: [],
        requiredBody: ["schema", "queryId", "subjectId", "accessGrantId", "caseId", "permissiblePurpose", "entityKind", "anchors", "attributes", "maxCandidates", "asOf", "knownAt"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["subject", "question", "purpose", "permissiblePurpose", "outputSchema", "budgets", "sourcePolicy", "caseId", "accessGrantId", "actorId", "retentionPolicyId", "humanReviewRequired", "candidateBinding", "providerPlan", "investigationProfile", "sourcePackIds", "continuationOfJobId"],
        forbiddenBody: [],
        requiredBody: ["subject", "question", "purpose", "permissiblePurpose", "outputSchema", "budgets", "sourcePolicy", "caseId", "actorId", "retentionPolicyId", "humanReviewRequired"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "risk:write",
...
private let temperaOperationChunk8: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["tenantId", "currency", "productName", "successUrl", "cancelUrl"],
        forbiddenBody: [],
        requiredBody: ["tenantId", "currency", "productName", "successUrl", "cancelUrl"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "payments:intents:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["tenantId", "acquirer", "successUrl", "failureUrl", "billing"],
        forbiddenBody: [],
        requiredBody: ["tenantId", "acquirer", "successUrl", "failureUrl", "billing"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "payments:intents:write",
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["tenantId", "country", "currency", "category", "platformFeeBps"],
        forbiddenBody: [],
...
private let temperaOperationChunk9: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["tenantId", "redirectUrl", "cancelUrl", "idempotencyKey"],
        forbiddenBody: [],
        requiredBody: ["tenantId", "redirectUrl", "cancelUrl", "idempotencyKey"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "payments:intents:write",
    ...
    TemperaOperationSpec(
        ...
        requiredHeaders: ["X-CC-Webhook-Signature"],
        body: [],
        forbiddenBody: [],
        requiredBody: [],
        bodyDefaults: [],
    ...
    TemperaOperationSpec(
        ...
        pathParams: [],
        pathParamTemplates: [],
        query: ["tenantId", "status", "pageSize", "pageToken"],
        requiredQuery: ["tenantId"],
        headers: [],
        requiredHeaders: [],
        body: [],
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["tenantId", "customerId", "paymentMethodId", "merchantId", "riskSubjectId", "recipient", "amount", "asset", "expiresInSeconds", "interval", "startAt", "consumer", "metadata", "idempotencyKey"],
        forbiddenBody: [],
        requiredBody: ["tenantId", "customerId", "paymentMethodId", "merchantId", "riskSubjectId", "recipient", "amount", "asset", "expiresInSeconds", "interval", "idempotencyKey"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        pathParams: [],
        pathParamTemplates: [],
        query: ["tenantId", "customerId", "status", "pageSize", "pageToken"],
        requiredQuery: ["tenantId"],
        headers: [],
        requiredHeaders: [],
        body: [],
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["extraction", "metadata"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "document:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["instructions", "maxOutputTokens", "schema", "schemaName", "unitIndexes"],
        forbiddenBody: [],
        requiredBody: ["schemaName", "schema", "instructions"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "document:write",
...
private let temperaOperationChunk10: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        auth: "oauthResource",
        authAudience: "tempera-document",
        pathParams: ["projectId", "operationId"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
...
private let temperaOperationChunk12: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["id", "name", "useCase", "instructions", "provider", "model", "voice", "language", "outputModality", "inputAudioFormat", "outputAudioFormat", "transcriptionModel", "turnDetection", "tools", "retention", "limits", "metadata"],
        forbiddenBody: [],
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["agentId", "channel", "externalId", "safetyIdentifier", "profileRef", "goalRef", "siteId", "metadata"],
        forbiddenBody: [],
        requiredBody: ["agentId"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "voice:write",
...
private let temperaOperationChunk13: [TemperaOperationSpec] = [
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["name", "contentBase64"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "voice:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["profileId", "sealedResultPath", "artifacts", "attestationPath", "attestationSignaturePath", "attestationPublicKeyPath"],
        forbiddenBody: [],
        requiredBody: ["profileId", "sealedResultPath", "artifacts"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "eval:run",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["profileId", "adapterImportPath", "adapterImportSignaturePath", "adapterImportPublicKeyPath", "releaseEvidencePath", "exposureLedgerPath", "redactionPolicyPath", "guardrailsPath", "preregistrationPath", "bundleId", "createdAt"],
        forbiddenBody: [],
        requiredBody: ["profileId", "adapterImportPath", "adapterImportSignaturePath", "adapterImportPublicKeyPath", "releaseEvidencePath", "exposureLedgerPath", "redactionPolicyPath", "guardrailsPath", "preregistrationPath", "bundleId"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "eval:run",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["profileId", "evidencePath", "kind", "signaturePath", "publicKeyPath", "tenantId", "projectId", "abPlanPath"],
        forbiddenBody: [],
        requiredBody: ["profileId", "evidencePath", "kind", "signaturePath", "publicKeyPath", "tenantId", "projectId"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "eval:run",
    ...
    TemperaOperationSpec(
        ...
        auth: "product",
        authAudience: nil,
        pathParams: ["storeId", "organization", "project", "environment", "site"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
    ...
    TemperaOperationSpec(
        ...
        headers: ["Idempotency-Key"],
        requiredHeaders: ["Idempotency-Key"],
        body: ["merchantId", "productClassification", "name", "description", "photoUrl", "currency", "unitAmountMinor", "expiresAt"],
        forbiddenBody: [],
        requiredBody: ["merchantId", "productClassification", "name", "description", "currency", "unitAmountMinor"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        auth: "product",
        authAudience: nil,
        pathParams: ["offerId", "organization", "project", "environment", "site"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["offerId", "offerRevision", "quantity"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:commerce:write",
    ...
    TemperaOperationSpec(
        ...
        body: ["expectedRevision", "record"],
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "record"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:write",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "quoteId"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:write",
    ...
    TemperaOperationSpec(
        ...
        auth: "product",
        authAudience: nil,
        pathParams: ["proposalId", "organization", "project", "environment", "site"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "proposalDigest"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["expectedRevision", "proposalDigest", "outcome", "evidenceRef"],
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "proposalDigest", "outcome", "evidenceRef"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:write",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "purchaseState", "evidenceRef"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:approve",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["expectedRevision", "profileRef", "profileRevision", "idempotencyKey"],
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "profileRef", "profileRevision"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:write",
    ...
    TemperaOperationSpec(
        ...
        auth: "product",
        authAudience: nil,
        pathParams: ["workspaceId", "taskId", "organization", "project", "environment", "site"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
        ...
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "draft"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:write",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "review"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:approve",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["expectedRevision", "receipt"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "orders:write",
    ...
    TemperaOperationSpec(
        ...
        auth: "product",
        authAudience: nil,
        pathParams: ["workspaceId", "organization", "project", "environment", "site"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
...
private let temperaOperationChunk14: [TemperaOperationSpec] = [
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["idempotencyKey", "intake"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["idempotencyKey", "expectedRevision", "intake"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "business:write",
    ...
    TemperaOperationSpec(
        ...
        forbiddenBody: [],
        requiredBody: ["idempotencyKey", "expectedRevision", "draft"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "business:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["idempotencyKey", "expectedRevision", "preparationDigest", "decision"],
        forbiddenBody: [],
        requiredBody: ["idempotencyKey", "expectedRevision", "preparationDigest", "decision"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["idempotencyKey", "expectedRevision", "preparationDigest", "receiptRef", "owner", "reportedOutcome"],
        forbiddenBody: [],
        requiredBody: ["idempotencyKey", "expectedRevision", "preparationDigest", "receiptRef", "owner", "reportedOutcome"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "business:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["idempotencyKey", "expectedRevision", "facts", "references", "availableServices"],
        forbiddenBody: [],
        requiredBody: ["idempotencyKey", "expectedRevision"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "business:write",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["authScheme", "baseUrl", "connectorId", "connectorRevision", "credentialName", "displayName", "operations", "specificationArtifactRef", "specificationDigest"],
        forbiddenBody: [],
        requiredBody: ["connectorId", "displayName"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["authScheme", "baseUrl", "connectorId", "credentialName", "displayName", "document", "sourceUrl"],
        forbiddenBody: [],
        requiredBody: ["displayName", "authScheme"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "connection:write",
    ...
    TemperaOperationSpec(
        ...
        auth: "oauthResource",
        authAudience: "tempera-investigations",
        pathParams: ["project", "investigation"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
...
private let temperaOperationChunk15: [TemperaOperationSpec] = [
    ...
    TemperaOperationSpec(
        ...
        auth: "oauthResource",
        authAudience: "tempera-investigations",
        pathParams: ["project", "investigation", "evaluation"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
    ...
    TemperaOperationSpec(
        ...
        auth: "oauthResource",
        authAudience: "tempera-investigations",
        pathParams: ["project", "investigation", "run"],
        pathParamTemplates: [],
        query: [],
        requiredQuery: [],
        headers: [],
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["actionId", "actor", "authorityAdmission", "causality", "evidence", "expiresAt", "idempotencyKey", "mandate", "preparedEffect", "principal", "purpose", "requestDigest", "risk", "schema", "workspace"],
        forbiddenBody: [],
        requiredBody: ["schema", "actionId", "workspace", "principal", "actor", "purpose", "idempotencyKey", "causality", "preparedEffect", "mandate", "authorityAdmission", "risk", "evidence", "expiresAt", "requestDigest"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["schema", "actionId", "workspace", "idempotencyKey", "preparedEffect"],
        forbiddenBody: [],
        requiredBody: ["schema", "actionId", "workspace", "idempotencyKey", "preparedEffect"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "clearing:actions:propose",
    ...
    TemperaOperationSpec(
        ...
        headers: [],
        requiredHeaders: [],
        body: ["action", "riskEvidenceEnvelope"],
        forbiddenBody: [],
        requiredBody: ["action", "riskEvidenceEnvelope"],
        bodyDefaults: [],
        requestBodyKind: "json",
        requestContentType: "application/json",
        scope: "clearing:actions:commit",
