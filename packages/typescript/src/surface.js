...
export const TEMPERA_OPERATIONS = Object.freeze(
{
  ...
  "temperaBio": [
    ...
    {
      "id": "prepareComputationalExperimentPlan",
      "upstreamOperationId": "prepareComputationalExperimentPlan",
      "method": "POST",
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare computational experiment plan."
    },
    {
    ...
    {
      "id": "verifyDomainMaterializationSubmission",
      "upstreamOperationId": "verifyDomainMaterializationSubmission",
      "method": "POST",
      "path": "/v1/domainMaterializations:verifySubmission",
      "auth": "oauthResource",
      "authAudience": "tempera-bio",
      "pathParams": [],
      "pathParamTemplates": {},
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Verify domain materialization submission."
    },
    {
    ...
    {
      "id": "prepareGraphProjection",
      "upstreamOperationId": "prepareGraphProjection",
      "method": "POST",
      "path": "/v1/graphProjections:prepare",
      "auth": "oauthResource",
      "authAudience": "tempera-bio",
      "pathParams": [],
      "pathParamTemplates": {},
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare graph projection."
    },
    {
    ...
    {
      "id": "prepareNeuralResponseTask",
      "upstreamOperationId": "prepareNeuralResponseTask",
      "method": "POST",
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare neural response task."
    },
    {
      "id": "prepareProgram",
    ...
    {
      "id": "prepareProteinVariantTask",
      "upstreamOperationId": "prepareProteinVariantTask",
      "method": "POST",
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare protein variant task."
    },
    {
      "id": "prepareScientificClaim",
      "upstreamOperationId": "prepareScientificClaim",
      "method": "POST",
      "path": "/v1/scientificClaims:prepare",
      "auth": "oauthResource",
      "authAudience": "tempera-bio",
      "pathParams": [],
      "pathParamTemplates": {},
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare scientific claim."
    },
    {
    ...
    {
      "id": "prepareStoichiometricExperiment",
      "upstreamOperationId": "prepareStoichiometricExperiment",
      "method": "POST",
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare stoichiometric experiment."
    },
    {
      "id": "prepareStoichiometricFeasibilityReceipt",
      "upstreamOperationId": "prepareStoichiometricFeasibilityReceipt",
      "method": "POST",
      ...
      "physicalAction": false,
      "prepareCommitRequired": false,
      "description": "Prepare stoichiometric feasibility receipt."
    }
  ],
  "temperaPayments": [
    {
