...
export const TEMPERA_PRODUCTS = Object.freeze(
{
  ...
  "humanData": {
    ...
    "audience": "human-data",
    "description": "Browser-agent human review: reviewers inspect session traces, record decisions, and return candidate cases to the agent quality loop. Passthrough client only; no typed operations yet."
  },
  "tempJs": {
    "name": "temp.js",
