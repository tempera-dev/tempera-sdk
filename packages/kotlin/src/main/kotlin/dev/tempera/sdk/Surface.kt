...
public object TemperaSurface {
    ...
    public val audiences: List<String> = listOf("palette", "tempo", "cradle", "remi", "human-data", "data-engine", "tempera-mcp", "tempera-code", "tempera-llm", "tempera-workflows", "tempera-gym", "tempera-bio", "tempera-document", "tempera-risk", "tempera-investigations", "tempera-payments", "tempera-dropshipping", "tempera-voice", "tempera-clearing", "tempera-business")
...
private fun buildOperations(): List<TemperaOperationSpec> {
    val all = ArrayList<TemperaOperationSpec>(489)
...
private object TemperaOperationChunk8 {
    val items: List<TemperaOperationSpec> = listOf(
        TemperaOperationSpec(
            ...
            body = listOf("request", "people_binding"),
            forbiddenBody = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "subject_id", "subject_type", "state", "attributes", "external_refs"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "subject_id", "subject_type"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("schema", "event_id", "event_type", "subject_id", "counterparty_id", "device_id", "amount", "event_time", "received_at", "attributes", "evidence_refs"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "event_id", "event_type", "subject_id", "event_time", "received_at"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "policy_id", "version", "use_case", "segment", "description", "default_action", "default_reason_code", "missing_data_action", "missing_data_reason_code", "conflict_strategy", "rules", "model_dependencies", "change_ticket", "created_by"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "policy_id", "version", "use_case", "default_action", "default_reason_code", "missing_data_action", "missing_data_reason_code", "conflict_strategy", "rules", "change_ticket", "created_by"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "model_id", "version", "state", "artifact_sha256", "runtime", "input_features", "output_feature", "training_data_refs", "validation_report_ref", "calibration", "limitations", "created_at", "approval_ids"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "model_id", "version", "state", "artifact_sha256", "runtime", "input_features", "output_feature", "training_data_refs", "validation_report_ref", "calibration", "limitations", "created_at", "approval_ids"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "algorithm", "key_id", "score", "signature"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "algorithm", "key_id", "score", "signature"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("deployment_id", "policy_id", "policy_version", "mode", "traffic_percent", "effective_at", "approval_ids"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("deployment_id", "policy_id", "policy_version", "mode", "traffic_percent", "effective_at", "approval_ids"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("schema", "request_id", "subject_id", "event_id", "use_case", "segment", "features", "model_versions", "evidence_refs", "as_of", "available_as_of", "execution_mode"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "request_id", "subject_id", "use_case", "as_of"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("index_name", "subject", "permissible_purpose", "case_id", "threshold", "max_candidates"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("index_name", "subject", "permissible_purpose", "case_id"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "case_id", "case_type", "state", "subject_ids", "alert_ids", "assigned_to", "disposition", "evidence_refs", "attributes"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "case_id", "case_type", "state", "subject_ids", "alert_ids", "assigned_to", "disposition", "evidence_refs", "attributes"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "grant_id", "case_id", "subject_ids", "actor_ids", "permissible_purpose", "allowed_fields", "allowed_providers", "third_party_disclosure_allowed", "valid_from", "expires_at", "created_by", "approval_ids", "change_ticket"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "grant_id", "case_id", "subject_ids", "actor_ids", "permissible_purpose", "allowed_fields", "allowed_providers", "third_party_disclosure_allowed", "valid_from", "expires_at", "created_by", "approval_ids", "change_ticket"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("schema", "profile_id", "subject_id", "entity_kind", "anchors", "attributes", "source_ids", "evidence_refs", "valid_from", "valid_to", "recorded_at", "retention_expires_at", "non_decisional"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "profile_id", "subject_id", "entity_kind", "anchors", "attributes", "source_ids", "evidence_refs", "valid_from", "valid_to", "recorded_at", "retention_expires_at"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("schema", "query_id", "subject_id", "access_grant_id", "case_id", "permissible_purpose", "entity_kind", "anchors", "attributes", "max_candidates", "as_of", "known_at"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema", "query_id", "subject_id", "access_grant_id", "case_id", "permissible_purpose", "entity_kind", "anchors", "attributes", "max_candidates", "as_of", "known_at"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
...
private object TemperaOperationChunk9 {
    val items: List<TemperaOperationSpec> = listOf(
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("subject", "question", "purpose", "permissible_purpose", "output_schema", "budgets", "source_policy", "case_id", "access_grant_id", "actor_id", "retention_policy_id", "human_review_required", "candidate_binding", "provider_plan", "investigation_profile", "source_pack_ids", "continuation_of_job_id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("subject", "question", "purpose", "permissible_purpose", "output_schema", "budgets", "source_policy", "case_id", "actor_id", "retention_policy_id", "human_review_required"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = null,
...
private object TemperaOperationChunk11 {
    val items: List<TemperaOperationSpec> = listOf(
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("tenant_id", "merchant_id", "risk_subject_id", "recipient", "asset", "amount", "expires_in_seconds"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("tenant_id", "merchant_id", "risk_subject_id", "recipient", "asset", "amount", "expires_in_seconds"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-payments",
            pathParams = listOf("payment_intent_id"),
            pathParamTemplates = emptyList(),
            query = listOf("tenant_id"),
            requiredQuery = listOf("tenant_id"),
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = emptyList(),
            forbiddenBody = emptyList(),
...
private object TemperaOperationChunk12 {
    val items: List<TemperaOperationSpec> = listOf(
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("tenant_id", "currency", "product_name", "success_url", "cancel_url"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("tenant_id", "currency", "product_name", "success_url", "cancel_url"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "payments:intents:write",
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("tenant_id", "acquirer", "success_url", "failure_url", "billing"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("tenant_id", "acquirer", "success_url", "failure_url", "billing"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "payments:intents:write",
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("tenant_id", "country", "currency", "category"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("tenant_id", "country", "currency", "category"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("tenant_id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("tenant_id"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "payments:merchants:read",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-document",
            pathParams = listOf("project_id", "document_id"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("instructions", "max_output_tokens", "schema", "schema_name", "unit_indexes"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("schema_name", "schema", "instructions"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "document:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("query", "strategy", "top_k"),
            forbiddenBody = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            pathParams = listOf("project_id", "document_id"),
            pathParamTemplates = emptyList(),
            query = listOf("page_size", "page_token"),
            requiredQuery = emptyList(),
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-document",
            pathParams = listOf("project_id", "operation_id"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_byte_length", "expected_sha256", "media_type"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("media_type"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "document:write",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-document",
            pathParams = listOf("project_id", "upload_id"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("byte_length", "sha256"),
            forbiddenBody = emptyList(),
            requiredBody = emptyList(),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
...
private object TemperaOperationChunk16 {
    val items: List<TemperaOperationSpec> = listOf(
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("id", "input_audio_format", "instructions", "language", "limits", "metadata", "model", "name", "output_audio_format", "output_modality", "provider", "retention", "tools", "transcription_model", "turn_detection", "use_case", "voice"),
            forbiddenBody = emptyList(),
...
private object TemperaOperationChunk17 {
    val items: List<TemperaOperationSpec> = listOf(
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("classification", "content_base64", "media_type", "name"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("name", "content_base64"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "voice:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("adapter_import_path", "adapter_import_public_key_path", "adapter_import_signature_path", "bundle_id", "created_at", "exposure_ledger_path", "guardrails_path", "preregistration_path", "profile_id", "redaction_policy_path", "release_evidence_path"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("profile_id", "adapter_import_path", "adapter_import_signature_path", "adapter_import_public_key_path", "release_evidence_path", "exposure_ledger_path", "redaction_policy_path", "guardrails_path", "preregistration_path", "bundle_id"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "eval:run",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("ab_plan_path", "evidence_path", "kind", "profile_id", "project_id", "public_key_path", "signature_path", "tenant_id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("profile_id", "evidence_path", "kind", "signature_path", "public_key_path", "tenant_id", "project_id"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "eval:run",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("handoff_path"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("handoff_path"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "eval:run",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("artifacts", "attestation_path", "attestation_public_key_path", "attestation_signature_path", "profile_id", "sealed_result_path"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("profile_id", "sealed_result_path", "artifacts"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "eval:run",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("draft", "profile_id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("profile_id", "draft"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "eval:run",
        ...
        TemperaOperationSpec(
            ...
            pathParams = emptyList(),
            pathParamTemplates = emptyList(),
            query = listOf("agent_id", "profile_ref", "limit"),
            requiredQuery = emptyList(),
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("agent_id", "channel", "external_id", "goal_ref", "metadata", "profile_ref", "safety_identifier", "site_id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("agent_id"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "voice:write",
        ...
        TemperaOperationSpec(
            ...
            pathParams = listOf("session_id"),
            pathParamTemplates = emptyList(),
            query = listOf("status", "limit", "after"),
            requiredQuery = emptyList(),
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            pathParams = listOf("session_id"),
            pathParamTemplates = emptyList(),
            query = listOf("after_sequence", "limit"),
            requiredQuery = emptyList(),
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("session_ids"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("session_ids"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "eval:run",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "idempotency_key", "profile_ref", "profile_revision"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "profile_ref", "profile_revision"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-dropshipping",
            pathParams = listOf("workspace_id", "organization", "project", "environment", "site"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-dropshipping",
            pathParams = listOf("workspace_id", "task_id", "organization", "project", "environment", "site"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "receipt"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "receipt"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("draft", "expected_revision"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "draft"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "review"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "review"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
...
private object TemperaOperationChunk18 {
    val items: List<TemperaOperationSpec> = listOf(
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("currency", "description", "expires_at", "merchant_id", "name", "photo_url", "product_classification", "unit_amount_minor"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("merchant_id", "product_classification", "name", "description", "currency", "unit_amount_minor"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-dropshipping",
            pathParams = listOf("offer_id", "organization", "project", "environment", "site"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "record"),
            forbiddenBody = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-dropshipping",
            pathParams = listOf("order_id", "organization", "project", "environment", "site"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            body = listOf("expected_revision", "record"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "record"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "quote_id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "quote_id"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("evidence_ref", "expected_revision", "purchase_state"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "purchase_state", "evidence_ref"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:approve",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-dropshipping",
            pathParams = listOf("proposal_id", "organization", "project", "environment", "site"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("evidence_ref", "expected_revision", "outcome", "proposal_digest"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "proposal_digest", "outcome", "evidence_ref"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "proposal_digest"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("expected_revision", "proposal_digest"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:approve",
        ...
        TemperaOperationSpec(
            ...
            headers = listOf("Idempotency-Key"),
            requiredHeaders = listOf("Idempotency-Key"),
            body = listOf("offer_id", "offer_revision", "quantity"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("offer_id", "offer_revision", "quantity"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:commerce:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("channel", "display_name", "id"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("id", "display_name"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "orders:write",
        ...
        TemperaOperationSpec(
            ...
            auth = "oauthResource",
            authAudience = "tempera-dropshipping",
            pathParams = listOf("store_id", "organization", "project", "environment", "site"),
            pathParamTemplates = emptyList(),
            query = emptyList(),
            requiredQuery = emptyList(),
            headers = emptyList(),
...
private object TemperaOperationChunk19 {
    val items: List<TemperaOperationSpec> = listOf(
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "idempotency_key", "reason"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "expected_revision"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("available_services", "facts", "idempotency_key", "references"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("available_services", "expected_revision", "facts", "idempotency_key", "references"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "expected_revision"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("idempotency_key", "intake", "profile_ref"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "intake"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "business:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "idempotency_key", "owner", "preparation_digest", "receipt_ref", "reported_outcome"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "expected_revision", "preparation_digest", "receipt_ref", "owner", "reported_outcome"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "business:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("draft", "expected_revision", "idempotency_key"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "expected_revision", "draft"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "business:write",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("decision", "expected_revision", "idempotency_key", "preparation_digest"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "expected_revision", "preparation_digest", "decision"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "business:review",
        ...
        TemperaOperationSpec(
            ...
            headers = emptyList(),
            requiredHeaders = emptyList(),
            body = listOf("expected_revision", "idempotency_key", "intake"),
            forbiddenBody = emptyList(),
            requiredBody = listOf("idempotency_key", "expected_revision", "intake"),
            bodyDefaults = emptyList(),
            requestBodyKind = "json",
            requestContentType = "application/json",
            scope = "business:write",
