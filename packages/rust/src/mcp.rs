...
mod tests {
    ...
    fn initialize_and_ping_bodies_are_exact_and_ids_increment() {
        ...
        let (id, body) = builder.initialize_body("tempera-sdk", "0.13.0");
        assert_eq!(id, 1);
        assert_eq!(
            body,
            "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"initialize\",\"params\":{\"protocolVersion\":\"2025-06-18\",\"capabilities\":{},\"clientInfo\":{\"name\":\"tempera-sdk\",\"version\":\"0.13.0\"}}}"
        );
