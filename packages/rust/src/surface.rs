...
pub const SCOPES: &[&str] = &[
    ...
    "connection:write",
    "connection:read",
    "authority:holds:read",
    "authority:holds:decide",
    "authority:holds:write",
    "authority:policies:read",
    "authority:policies:write",
    "authority:credentials:release",
    "authority:ledger:read",
...
pub const PRODUCTS: &[ProductSpec] = &[
    ...
    ProductSpec {
        ...
        audience: Some("tempera-investigations"),
    ...
    ProductSpec {
        ...
        audience: Some("tempera-clearing"),
...
pub const OPERATIONS: &[OperationSpec] = &[
    ...
    OperationSpec {
        ...
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("account:credentialAdmin"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("account:billingAdmin"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        required_headers: &["tempera-event-signature"],
        body: &[],
        forbidden_body: &[],
        required_body: &[],
        body_defaults: &[],
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-code"),
        path_params: &[],
        path_param_templates: &[],
        query: &[],
        required_query: &[],
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("account:usageReader"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("account:platformStaff"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-authority"),
        path_params: &[],
        path_param_templates: &[],
        query: &["pageSize", "pageToken"],
        required_query: &[],
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("authority:policies:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "name", "document"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("authority:policies:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("authority:holds:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("authority:holds:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("authority:holds:decide"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["decisionToken", "preparedEffectDigest", "callDigest"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("authority:holds:write"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["leaseToken", "leaseFence", "outcomeDigest"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("authority:holds:write"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["effectDigest", "callDigest"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("authority:credentials:release"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("authority:ledger:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["planId", "paymentMethodId"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("account:billingAdmin"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["planId", "prices", "reason"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("account:platformStaff"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["productId", "unit", "mode", "reason"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("account:platformStaff"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["tenantId", "idempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:refunds:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "idempotent",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("payments:refunds:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-payments"),
        path_params: &["paymentIntentId", "refundId"],
        path_param_templates: &[],
        query: &["tenantId"],
        required_query: &["tenantId"],
        headers: &[],
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["tenantId", "returnUrl", "cancelUrl", "idempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:intents:write"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["tenantId", "redirectUrl", "cancelUrl", "idempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:intents:write"),
    ...
    OperationSpec {
        ...
        required_headers: &["X-CC-Webhook-Signature"],
        body: &[],
        forbidden_body: &[],
        required_body: &[],
        body_defaults: &[],
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["tenantId", "url", "eventTypes"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:webhooks:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("payments:webhooks:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["tenantId", "paymentMethodId", "idempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:intents:write"),
    ...
    OperationSpec {
        ...
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:customers:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("payments:customers:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["tenantId", "successUrl", "cancelUrl", "idempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:customers:write"),
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-payments"),
        path_params: &["customerId", "paymentMethodId"],
        path_param_templates: &[],
        query: &["tenantId"],
        required_query: &["tenantId"],
        headers: &[],
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("payments:disputes:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("payments:subscriptions:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "idempotent",
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("payments:subscriptions:read"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "read",
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-investigations"),
        path_params: &["project"],
        path_param_templates: &[],
        query: &[],
        required_query: &[],
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("investigation:write"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-investigations"),
        path_params: &["project", "investigation"],
        path_param_templates: &[],
        query: &[],
        required_query: &[],
        headers: &[],
    ...
    OperationSpec {
        ...
        request_body_kind: "none",
        request_content_type: None,
        scope: Some("investigation:review"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "none",
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-investigations"),
        path_params: &["project", "investigation", "evaluation"],
        path_param_templates: &[],
        query: &[],
        required_query: &[],
        headers: &[],
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-investigations"),
        path_params: &["project", "investigation", "run"],
        path_param_templates: &[],
        query: &[],
        required_query: &[],
        headers: &[],
    ...
    OperationSpec {
        ...
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("clearing:actions:propose"),
        physical_action: false,
        prepare_commit_required: false,
        safe_retry: "idempotent",
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["action", "riskEvidenceEnvelope"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("clearing:actions:commit"),
