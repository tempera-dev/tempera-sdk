...
pub const OPERATIONS: &[OperationSpec] = &[
    ...
    OperationSpec {
        ...
        physical_action: false,
        prepare_commit_required: false,
        description: "Call POST /v1/actions:validate.",
    },
    OperationSpec {
        product: "tempera_clearing",
    ...
    OperationSpec {
        ...
        physical_action: false,
        prepare_commit_required: false,
        description: "Call GET /v1/actions/{id}.",
    },
    OperationSpec {
        product: "tempera_clearing",
        ...
        physical_action: false,
        prepare_commit_required: false,
        description: "Call GET /v1/actions/{id}/events.",
    },
    OperationSpec {
        product: "tempera_clearing",
        ...
        physical_action: false,
        prepare_commit_required: false,
        description: "Durably commit the exact previously prepared and authority-bound action.",
    },
    OperationSpec {
