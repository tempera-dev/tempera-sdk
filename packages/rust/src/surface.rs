...
pub const OPERATIONS: &[OperationSpec] = &[
    ...
    OperationSpec {
        ...
        path_params: &[],
        query: &[],
        body: &["model", "messages", "max_tokens", "temperature", "stream", "byok"],
    ...
    OperationSpec {
        ...
        path_params: &[],
        query: &[],
        body: &["contractVersion", "id", "name", "description", "nodes", "edges", "settings"],
    ...
    OperationSpec {
        ...
        path_params: &[],
        query: &[],
        body: &["mode", "purpose", "expectedRoot", "context", "current", "prompt"],
    ...
    OperationSpec {
        ...
        query: &[],
        body: &["training_product_id", "heldout_product_id", "idempotency_key"],
        required_body: &["training_product_id", "heldout_product_id", "idempotency_key"],
        body_defaults: &[],
    ...
    OperationSpec {
        ...
        path_params: &["project_id"],
        query: &[],
        body: &["schema_version", "domain", "evidence_type", "payload_schema", "payload", "source_artifact_refs", "artifact_refs", "verification_state", "verifier_receipt_artifact_refs", "quality_flags", "provenance"],
        required_body: &["schema_version", "domain", "evidence_type", "payload_schema", "payload", "source_artifact_refs", "verification_state"],
        body_defaults: &[],
        scope: Some("eval:run"),
    ...
    OperationSpec {
        ...
        path_params: &["project_id"],
        query: &[],
        body: &["schema_version", "domain", "context_evidence_ref", "environment_ref", "seed", "observations", "tool_calls", "measured_outcomes", "verifier_results", "reward_components", "terminal_reason", "uncertainty", "provenance", "safety_events"],
        required_body: &["schema_version", "domain", "context_evidence_ref", "environment_ref", "seed", "observations", "measured_outcomes", "verifier_results", "reward_components", "terminal_reason"],
        body_defaults: &[],
        scope: Some("eval:run"),
    ...
    OperationSpec {
        ...
        query: &[],
        body: &["label", "outcome", "confidence", "rationale", "evidence", "annotator_id", "idempotency_key", "lease_token", "review_context"],
    ...
    OperationSpec {
        ...
        path_params: &["project_id", "expert_task_id"],
        query: &[],
        body: &["idempotency_key", "lease_token", "draft", "expected_version"],
        required_body: &["idempotency_key", "lease_token", "draft", "expected_version"],
        body_defaults: &[],
        scope: Some("review:resolve"),
    ...
    OperationSpec {
        ...
        path_params: &["project_id"],
        query: &[],
        body: &["connector", "bucket", "prefix", "key", "max_objects", "max_bytes", "statement", "limit", "soql", "max_pages", "artifact_type", "source", "ingest", "metadata"],
    ...
    OperationSpec {
        ...
        path_params: &["project_id"],
        query: &[],
        body: &["name", "description", "input_schema", "kind", "implementation", "created_by"],
