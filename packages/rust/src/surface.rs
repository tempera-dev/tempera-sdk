...
pub const OPERATIONS: &[OperationSpec] = &[
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "provider", "name", "secretRef"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "provider", "providerKind", "name", "secretRef", "capabilities"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "approvalId", "proposalDigest", "protocolDigest", "mcpPrepareReceiptDigest", "mcpCommitReceiptDigest", "submissionIdempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "proposalDigest", "protocolDigest", "connectionId", "mcpPrepareReceiptDigest", "expiresAt"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("bio:experiment:approve"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "idempotencyKey", "provider", "model", "configId", "byok", "maximumProviderCostMicros"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["orgId", "projectId", "environmentId", "configId", "reason", "observedUsage"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["evaluatorId", "evaluatorVersionId", "agentReleaseId", "kind"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["evaluatorId", "evaluatorVersionId", "agentReleaseId", "kind", "providerSecretId"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["baselineReleaseId", "candidateReleaseId", "evaluatorId", "evaluatorVersionId", "kind", "baselineOutputs", "candidateOutputs"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["baselineReleaseId", "candidateReleaseId", "evaluatorId", "evaluatorVersionId", "kind", "baselineOutputs", "candidateOutputs", "providerSecretId"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["scope", "traceId", "spanId", "seq", "kind", "name", "status", "attributes", "redactionClass"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("trace:write"),
    ...
    OperationSpec {
        ...
        path_param_templates: &[],
        query: &[],
        body: &["byok", "max_tokens", "messages", "model", "response_format", "stream", "temperature"],
        forbidden_body: &[],
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "subject_id", "subject_type"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "event_id", "event_type", "subject_id", "event_time", "received_at"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "policy_id", "version", "use_case", "default_action", "default_reason_code", "missing_data_action", "missing_data_reason_code", "conflict_strategy", "rules", "change_ticket", "created_by"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "model_id", "version", "state", "artifact_sha256", "runtime", "input_features", "output_feature", "training_data_refs", "validation_report_ref", "calibration", "limitations", "created_at", "approval_ids"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "algorithm", "key_id", "score", "signature"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["deployment_id", "policy_id", "policy_version", "mode", "traffic_percent", "effective_at", "approval_ids"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "request_id", "subject_id", "use_case", "as_of"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["index_name", "subject", "permissible_purpose", "case_id"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "case_id", "case_type", "state", "subject_ids", "alert_ids", "assigned_to", "disposition", "evidence_refs", "attributes"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "grant_id", "case_id", "subject_ids", "actor_ids", "permissible_purpose", "allowed_fields", "allowed_providers", "third_party_disclosure_allowed", "valid_from", "expires_at", "created_by", "approval_ids", "change_ticket"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "profile_id", "subject_id", "entity_kind", "anchors", "attributes", "source_ids", "evidence_refs", "valid_from", "valid_to", "recorded_at", "retention_expires_at"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema", "query_id", "subject_id", "access_grant_id", "case_id", "permissible_purpose", "entity_kind", "anchors", "attributes", "max_candidates", "as_of", "known_at"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        path_param_templates: &[],
        query: &[],
        body: &["subject", "question", "purpose", "permissible_purpose", "output_schema", "budgets", "source_policy", "case_id", "access_grant_id", "actor_id", "retention_policy_id", "human_review_required", "candidate_binding", "provider_plan", "investigation_profile", "source_pack_ids"],
        forbidden_body: &[],
        required_body: &["subject", "question", "purpose", "permissible_purpose", "output_schema", "budgets", "source_policy", "case_id", "actor_id", "retention_policy_id", "human_review_required"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["prospectiveProtocol", "experimentProposal", "connectionId", "approvalId", "mcpPrepareReceiptDigest", "mcpCommitReceiptDigest", "submissionIdempotencyKey"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("bio:experiment:submit"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schemaVersion", "campaignDigest", "datasetDigest", "candidateSetDigest", "model", "policy", "shadowPolicies", "mode", "constraints", "candidates"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("eval:run"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["program", "hypothesis", "candidateSet", "experimentProposal", "verifierReceipts"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("bio:decision:write"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["program", "candidateSet", "campaignContext", "batchProposal"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("bio:proposal:write"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["candidate", "program", "hypothesis", "experimentProposal", "rawMeasurementBase64", "identitySignature"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-document"),
        path_params: &["project_id", "document_id"],
        path_param_templates: &[],
        query: &[],
        body: &[],
        forbidden_body: &[],
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schema_name", "schema", "instructions"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("document:write"),
    ...
    OperationSpec {
        ...
        auth: "oauthResource",
        auth_audience: Some("tempera-document"),
        path_params: &["project_id", "upload_id"],
        path_param_templates: &[],
        query: &[],
        body: &[],
        forbidden_body: &[],
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["requestId", "adapterId", "contractVersion", "processTerminated", "temporaryProfileRemoved", "plaintextArtifactsRemoved", "egressLogSealedOrDiscarded", "sealedArtifactHandles", "proofIds", "notes"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["adapterId", "contractVersion", "launchEndpoint", "supportedLevels", "supportedControls", "guardFields", "completionProofs"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: None,
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schemaVersion", "requestId", "releaseId", "releaseKind", "evidenceClass", "claimClass", "bindings", "lineageEdges", "budget", "eligibility", "prospectiveExecution"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("eval:run"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schemaVersion", "domain", "evidenceType", "payloadSchema", "payload", "sourceArtifactRefs", "verificationState"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("eval:run"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["schemaVersion", "domain", "contextEvidenceRef", "environmentRef", "seed", "observations", "measuredOutcomes", "verifierResults", "rewardComponents", "terminalReason"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("eval:run"),
    ...
    OperationSpec {
        ...
        forbidden_body: &[],
        required_body: &["kind", "version", "obligationHash", "capabilityRoute", "provenance"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("dataset:write"),
