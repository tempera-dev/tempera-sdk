...
pub const OPERATIONS: &[OperationSpec] = &[
    ...
    OperationSpec {
        ...
        query: &[],
        required_query: &[],
        body: &["scientificClaim", "sourceSnapshots"],
        forbidden_body: &[],
        required_body: &["scientificClaim", "sourceSnapshots"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("bio:claim:prepare"),
        physical_action: false,
        prepare_commit_required: false,
    ...
    OperationSpec {
        ...
        query: &[],
        required_query: &[],
        body: &["experiment", "flux", "schemaVersion"],
        forbidden_body: &[],
        required_body: &["schemaVersion", "flux", "experiment"],
        body_defaults: &[],
        request_body_kind: "json",
        request_content_type: Some("application/json"),
        scope: Some("bio:measurement:verify"),
