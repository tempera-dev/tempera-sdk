...
pub const OPERATIONS: &[OperationSpec] = &[
    ...
    OperationSpec {
        ...
        path_params: &[],
        query: &[],
        body: &["question", "max_tokens", "require_fresh", "modes", "reconstruction_mode", "max_reconstruction_steps", "max_reconstruction_tokens"],
        forbidden_body: &["scope", "tenant_id", "project_id", "environment_id"],
        required_body: &[],
        body_defaults: &[],
        scope: None,
    ...
    OperationSpec {
        ...
        path_params: &[],
        query: &[],
        body: &["schema", "retrieval_receipt_id", "evidence_node_id", "helpful", "outcome_artifact_id", "note", "terminal_state", "idempotency_key"],
        forbidden_body: &["scope", "tenant_id", "project_id", "environment_id"],
        required_body: &[],
        body_defaults: &[],
        scope: None,
